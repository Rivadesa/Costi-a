-- Esquema v1 (native_d1, monolitico) tal como lo creaban los binarios hasta 0.26.0-e1. FIXTURE de pruebas: sirve para
-- construir una base "antigua" real y probar que upgrade la migra a v2 y que una copia v1 sigue restaurandose (E1b, ADR-012).
-- NO se usa en producto. Nunca cambia.
