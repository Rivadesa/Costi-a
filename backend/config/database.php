...
return [
    ...
    'connections' => [
        'pgsql' => [
            'driver' => 'pgsql', 'url' => env('DB_URL'),
            'host' => env('DB_HOST', '127.0.0.1'), 'port' => env('DB_PORT', '5432'),
            'database' => env('DB_DATABASE', 'hospitality'),
            'username' => env('DB_USERNAME', 'hospitality'), 'password' => env('DB_PASSWORD', ''),
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug((string) env('APP_NAME', 'hospitality-os'), '_').'_database_'),
        ],
        'default' => [
