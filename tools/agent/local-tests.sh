...
ALL="packaging_http native_http security_http desktop_reads affordances_http restrictions_http checkout_http identity_http pairing_http station_http organization_http pwa_http"
